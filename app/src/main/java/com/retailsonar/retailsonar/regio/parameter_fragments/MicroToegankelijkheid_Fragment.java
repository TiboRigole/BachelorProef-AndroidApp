...
public class MicroToegankelijkheid_Fragment extends Fragment {
    Pand huidigPand;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_microtoegankelijkheid, container, false);
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("microtoegankelijkheid");
        ...
        afbeeldingen[0]=view.findViewById(R.id.micro1);
        afbeeldingen[1]=view.findViewById(R.id.micro2);
        afbeeldingen[2]=view.findViewById(R.id.micro3);
        score=view.findViewById(R.id.barMicro);
        score.setProgress(huidigPand.getMicrotoegankelijkheid());
        selectImage();
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setMicrotoegankelijkheid(score.getProgress());
        super.onPause();
    }
