...
public class Toegankelijkheid_Fragment extends Fragment {
    Pand huidigPand;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_toegankelijkheid, container, false);
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("toegankelijkheid");
        ...
        afbeeldingen[0]=view.findViewById(R.id.toegank1);
        afbeeldingen[1]=view.findViewById(R.id.toegank2);
        afbeeldingen[2]=view.findViewById(R.id.toegank3);
        score=view.findViewById(R.id.barToegang);
        score.setProgress(huidigPand.getToegankelijkheid());
        selectImage();
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setToegankelijkheid(score.getProgress());
        super.onPause();
    }
