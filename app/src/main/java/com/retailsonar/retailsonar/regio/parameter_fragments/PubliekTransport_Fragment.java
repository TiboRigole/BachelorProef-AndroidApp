...
public class PubliekTransport_Fragment extends Fragment {
    Pand huidigPand;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_publiektransport, container, false);
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("publiektransport");
        ...
        afbeeldingen[0]=view.findViewById(R.id.publiektrans1);
        afbeeldingen[1]=view.findViewById(R.id.publiektrans2);
        afbeeldingen[2]=view.findViewById(R.id.publiektrans3);

        afbeeldingen[0].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                huidigPand.setPubliekTransport(1);
                getScore();
            }
        });
        ...
        afbeeldingen[1].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                huidigPand.setPubliekTransport(2);
                getScore();
            }
        });


        afbeeldingen[2].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                huidigPand.setPubliekTransport(3);
                getScore();
            }
        });
    ...
    public void getScore(){
        if(huidigPand.getPubliekTransport()==1){
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setPubliekTransport(huidigPand.getPubliekTransport());
        super.onPause();
    }
