...
public class Parking_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("parking");
        ...
        afbeeldingen[0]=view.findViewById(R.id.parking1);
        afbeeldingen[1]=view.findViewById(R.id.parking2);
        afbeeldingen[2]=view.findViewById(R.id.parking3);

        afbeeldingen[0].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                huidigPand.setParking(1);
                getScore();
            }
        });
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setParking(huidigPand.getParking());
        super.onPause();
    }
