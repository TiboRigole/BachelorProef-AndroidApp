...
public class Passage_Fragment extends Fragment {
    Pand huidigPand;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_passage, container, false);
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("passage");
        ...
        afbeeldingen[0]=view.findViewById(R.id.passage1);
        afbeeldingen[1]=view.findViewById(R.id.passage2);
        afbeeldingen[2]=view.findViewById(R.id.passage3);
        score=view.findViewById(R.id.barPassage);
        score.setProgress(huidigPand.getPassage());
        selectImage();
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setPassage(score.getProgress());
        super.onPause();
    }
