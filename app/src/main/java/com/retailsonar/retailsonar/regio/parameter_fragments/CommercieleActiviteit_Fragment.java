...
public class CommercieleActiviteit_Fragment extends Fragment {
    Pand huidigPand;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_commercieleactiviteit, container, false);
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("commercieleactiviteit");
        ...
        afbeeldingen[0]=view.findViewById(R.id.comact1);
        afbeeldingen[1]=view.findViewById(R.id.comact2);
        afbeeldingen[2]=view.findViewById(R.id.comact3);
        score=view.findViewById(R.id.barComAct);
        score.setProgress(Integer.parseInt(huidigPand.getCommercieleActiviteit()));
        selectImage();
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setCommercieleActiviteit(Integer.toString(score.getProgress()));
        super.onPause();
    }
