...
public class ShopAreaAppreciation_Fragment extends Fragment {
    Pand huidigPand;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_shopareaappreciation, container, false);
        ...
        Call<JsonObject> eigenschappenRequest= parameterService.getEigenschappen("shopareaappreciation");
        ...
        afbeeldingen[0]=view.findViewById(R.id.shoprep1);
        afbeeldingen[1]=view.findViewById(R.id.shoprep2);
        afbeeldingen[2]=view.findViewById(R.id.shoprep3);
        score=view.findViewById(R.id.barShopRep);
        score.setProgress(huidigPand.getShopareaappreciation());
        selectImage();
    ...
    public void onPause() {
        ...
        ((Activity_Invul_Parameters)getActivity()).getPand().setShopareaappreciation(score.getProgress());
